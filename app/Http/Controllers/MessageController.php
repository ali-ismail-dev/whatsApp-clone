...
class MessageController extends Controller
{
    ...
    public function byGroup(Group $group)
    {
        ...
        return inertia('Home', ['selectedConversation' => $group->toConversationArray(Auth::user()), 'messages' => MessageResource::collection($messages)]);
    }
    ...
    public function store(StoreMessageRequest $request)
    {
        ...
        if ($receiver->id) {
            Conversation::updateConversationWithMessage($receiver->id, Auth::id(), $message);
        }
