      ...
      <Menu as="div" className="relative inline-block text-left">
        <div>
          <Menu.Button className="relative p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            {unreadCount > 0 && (
              <span className="absolute -top-0 -right-0 inline-flex items-center justify-center px-1.5 py-0.5 text-xs font-medium leading-none text-red-800 bg-red-200 rounded-full">
                {unreadCount}
              </span>
            )}
          </Menu.Button>
